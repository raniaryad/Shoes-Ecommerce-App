...
class SideMenue extends StatefulWidget {
  SideMenue({Key? key ,}) :super(key: key);
      ...
      child: ListView(
        ...
        children: [
          ...
          UserAccountsDrawerHeader(
            accountName: Text("Hey",style: TextStyle(
              color: AppColores.graycolor,
              fontSize: 20,
              fontWeight: FontWeight.w500,
            ),),

            accountEmail: Text( "Alisson becker",style: TextStyle(
          ...
          ListTile(
            leading: Icon(Icons.person_outline_sharp,color: AppColores.graycolor),
            title: Text("Profile",style: TextStyle(
              fontSize: 15,color:AppColores.whitecolor,
          ...
          ListTile(
            leading: Icon(Icons.water_damage_outlined,color: AppColores.graycolor),
          ...
          ListTile(
            leading: Icon(Icons.local_mall_outlined,color: AppColores.graycolor),
          ...
          ListTile(
            leading: Icon(Icons.local_shipping_outlined,color: AppColores.graycolor),
          ...
          ListTile(
            leading: Icon(Icons.notifications_active_outlined,color: AppColores.graycolor),
          ...
          SizedBox(height: 35),
          Divider(height: 20,thickness: 1, color:Color(0xff707b81) ,),
